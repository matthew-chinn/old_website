...
//card is the div of the card, cardsChosen is an array, numChosen is an int
...
var removeCard = function(array, divId, num)
{
	...
	//var loc = arrayValues.indexOf(num);
